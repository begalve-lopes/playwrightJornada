...
test.describe('Buscar passagens', () => {
    test('Deve buscar passagens somente ida, economica', async ({ paginaPrincipal }) => {
    ...
    test('Deve buscar passagens somente ida, executiva', async ({ page, paginaPrincipal }) => {
        ...
        await paginaPrincipal.estaMostarandoPassagem('Somente ida', 'Paraíba', 'Roraima');
    })
})